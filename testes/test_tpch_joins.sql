...
SELECT * FROM lineitem JOIN partsupp ON l_partkey = ps_partkey AND l_suppkey = ps_suppkey;
...
SELECT * FROM partsupp JOIN part ON ps_partkey = p_partkey;

CREATE TABLE join_partsupp_supplier AS 
SELECT * FROM partsupp JOIN supplier ON ps_suppkey = s_suppkey;
...
SELECT * FROM lineitem JOIN supplier ON l_suppkey = s_suppkey;
...
SELECT * FROM lima_discover('join_lineitem_orders', threshold=0.0000000001);

SELECT '--- join_lineitem_partsupp ---' AS section;
SELECT * FROM lima_discover('join_lineitem_partsupp', threshold=0.0000000001);

SELECT '--- join_customer_orders ---' AS section;
SELECT * FROM lima_discover('join_customer_orders', threshold=0.0000000001);

SELECT '--- join_partsupp_part ---' AS section;
SELECT * FROM lima_discover('join_partsupp_part', threshold=0.0000000001);

SELECT '--- join_partsupp_supplier ---' AS section;
SELECT * FROM lima_discover('join_partsupp_supplier', threshold=0.0000000001);

SELECT '--- join_customer_nation ---' AS section;
SELECT * FROM lima_discover('join_customer_nation', threshold=0.0000000001);

SELECT '--- join_nation_supplier ---' AS section;
SELECT * FROM lima_discover('join_nation_supplier', threshold=0.0000000001);

SELECT '--- join_nation_region ---' AS section;
SELECT * FROM lima_discover('join_nation_region', threshold=0.0000000001);

SELECT '--- join_lineitem_part ---' AS section;
SELECT * FROM lima_discover('join_lineitem_part', threshold=0.0000000001);

SELECT '--- join_lineitem_supplier ---' AS section;
SELECT * FROM lima_discover('join_lineitem_supplier', threshold=0.0000000001);

-- Run discovery on the 3-way join
SELECT '--- join_lineitem_part_supplier ---' AS section;
SELECT * FROM lima_discover('join_lineitem_part_supplier', threshold=0.0000000001);
